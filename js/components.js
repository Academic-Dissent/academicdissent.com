        ...
        this.innerHTML = `
            <header class="site-header">
              ...
              <nav class="site-nav">
                ...
                <!-- The button explicitly calls the function -->
                <span id="auth-nav">
            ...
            <div id="auth-modal" class="modal">
              <div class="modal-content">
                ...
                <form id="authForm" class="dissent-form">
                  ...
                  <!-- Turnstile Container (Hidden by default) -->
                  <div id="recaptcha-container" style="display: none; margin-bottom: 1.5rem; display: flex; justify-content: center;">
                      <div class="cf-turnstile" data-sitekey="0x4AAAAAAC0vaZlDMf_ZGE8y"></div>
                  </div>
